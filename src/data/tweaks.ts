...
// This is the historical catalogue retained temporarily for source history.  Do
// not expose entries from it directly: many of the old entries target
// undocumented driver keys or make untestable performance claims.
const auditedCatalogue: Tweak[] = [
  // ── SYSTEM ──
{
...
/**
 * Curated, supportable Windows 10/11 actions.  Every id here has a matching
 * verified implementation in electron/main.js.  Adding an item requires an
 * apply, verification, and restore path; UI copy alone is not enough.
 */
const APPROVED_TWEAK_IDS = new Set([
  'sys-high-performance','sys-enable-game-mode','sys-disable-gamebar','mouse-disable-acceleration',
  'cpu-core-parking-disable','sys-disable-hibernation','storage-ssd-optimization','storage-trim-optimization',
  'windows-explorer-optimization','sys-disable-tips','sys-disable-widgets','sys-disable-activity-history',
  'sys-disable-location','privacy-disable-ad-id','sys-disable-vbs','sys-disable-mitigations',
  'sys-optimize-fps','gpu-max-performance-mode','gpu-disable-power-gating','net-optimize-performance',
  'sys-disable-power-throttling','sys-set-timer-resolution','game-optimize-scheduler','audio-disable-enhancements',
  'sys-optimize-dpc-latency','game-optimize-directx','sys-disk-cleanup','sys-cpu-priority',
  'memory-working-set','sys-disable-xbox','sys-optimize-device-affinities','sys-optimize-msi',
  'sys-reduce-background','sys-enable-modern-memory','sys-disable-services','sys-optimize-storage',
  'sys-reduce-boot-timeout','sys-optimize-explorer','sys-disable-boot-interface','sys-optimize-browser-bg',
  'nv-disable-vsync','nv-low-latency','nv-hardware-scheduling','nv-texture-filtering',
  'nv-disable-telemetry','nv-optimize-performance','nv-enhance-privacy','nv-enable-dlss-indicator',
  'net-optimize-dns','net-reduce-congestion','net-disable-lso','net-disable-nagle',
  'net-disable-power-saving','net-optimize-mtu','net-disable-network-throttling','net-optimize-connection-limits',
  'net-disable-netbios','net-optimize-dns-cache','net-disable-ecns','net-optimize-rss',
  'net-disable-rsc','net-disable-task-offload','net-optimize-tcp-window','net-disable-flow-control',
  'net-optimize-adapter','net-disable-llmnr','net-disable-wsd','net-disable-ecnc',
  'net-block-telemetry-firewall','net-block-edge-firewall','net-disable-arbitration',
  'net-disable-gro-segmentation','net-disable-interrupt-moderation','net-increase-receive-buffers',
  'net-increase-transmit-buffers','net-optimize-tcp-nodelay',
  'storage-trim-optimization','storage-nvme-optimization','storage-prefetch-manager',
  'storage-enable-write-cache','storage-disable-ahci-link-power','storage-optimize-defrag',
  'storage-set-io-priority','storage-disable-indexing','storage-optimize-io-priority',
  'storage-nvme-latency-optimization','storage-optimize-defrag-schedule','storage-optimize-nvme-queues',
  'storage-disable-write-caching','storage-disable-disk-compression','storage-disable-ahci-power',
  'storage-disable-indexing-service',
  'audio-disable-enhancements','audio-usb-optimization','audio-optimize-buffer-size',
  'audio-disable-spatial-sound','audio-set-exclusive-mode','audio-disable-midi-synth',
  'audio-optimize-sample-rate','audio-disable-low-latency','audio-optimize-latency',
  'audio-disable-all-enhancements',
  'snd-exclusive-mode','snd-reduce-buffer','snd-mmcss-audio','snd-disable-spatial',
  'snd-optimize-sample-rate','snd-disable-midi','snd-optimize-audio-thread','snd-disable-audio-gpu-sync',
  'usb-selective-suspend-disable','keyboard-disable-filter','keyboard-usb-power-mgmt',
  'usb-disable-hub-power','usb-optimize-transfer-rate','usb-disable-compliance',
  'keyboard-disable-ghosting','keyboard-optimize-repeat-rate','keyboard-optimize-repeat-delay',
  'keyboard-optimize-battery',
  'privacy-reduce-ads','privacy-optimize-smb','privacy-disable-security-questions',
  'privacy-harden-security','privacy-disable-vpn','privacy-disable-ucpd','privacy-unlock-eu-privacy',
  'privacy-redirect-web-searches','privacy-disable-driver-updates','privacy-disable-vm-support',
  'privacy-disable-ad-id','privacy-disable-app-launch','privacy-disable-cortana-deep',
  'privacy-disable-telemetry-deep','privacy-disable-tracking',
  'sys-disable-fullscreen-opt','sys-disable-gamebar','sys-disk-cleanup',
  'sys-disable-fast-startup','sys-disable-sticky-keys','sys-disable-filter-keys',
  'sys-disable-toggle-keys','sys-disable-mouse-trails',
  'sys-enable-ultimate-performance','sys-disable-animations','sys-disable-transparency',
  'sys-disable-services','sys-optimize-storage','sys-reduce-boot-timeout',
  'sys-optimize-explorer','sys-disable-boot-interface','sys-optimize-browser-bg',
  'sys-disable-error-reporting','sys-disable-delivery-optimization','sys-disable-location',
  'sys-disable-find-my-device','sys-disable-activity-history','sys-disable-taskbar-search',
  'sys-disable-cortana','sys-disable-cloud-clipboard','sys-disable-meet-now',
  'sys-disable-people-bar','sys-disable-search-highlights','sys-disable-taskbar-feed',
  'sys-disable-lockscreen-notifications','sys-disable-action-center','sys-disable-scheduled-defrag',
  'sys-disable-lockscreen-spotlight','sys-disable-start-suggestions','sys-disable-clipboard-history',
  'sys-disable-feedback','sys-disable-suggested-content','sys-disable-web-search',
  'sys-disable-task-view','sys-disable-spectre-mitigations','sys-use-platform-clock',
  'sys-disable-dynamic-tick','sys-optimize-context-menu','sys-clear-system-cache',
  'sys-disable-prefetch','sys-optimize-file-cache','sys-optimize-interrupts',
  'sys-block-update-restart','sys-defer-feature-updates','sys-pause-updates',
  'sys-realtime-priority-games','sys-foreground-boost','sys-optimize-fps',
  'sys-disable-power-throttling','sys-set-timer-resolution','sys-optimize-dpc-latency',
  'sys-cpu-priority','memory-working-set','sys-enable-modern-memory',
  'bcd-timer-resolution','bcd-disable-dynamic-tick','bcd-use-platform-clock',
  'bcd-increase-usnjrnl','bcd-optimize-boot','bcd-disable-quiet-boot',
  'bcd-increase-stack','bcd-optimize-test-signing',
  'nv-max-power-management','nv-disable-thermal-throttle','nv-optimize-pcie',
  'nv-disable-gpu-preemption','nv-max-frames-ahead','nv-disable-mpo',
  'nv-shader-cache-size','nv-optimization-level','nv-disable-spread-spectrum',
  'nv-rm-gpu-accl','nv-disable-ansel','nv-disable-shadowplay','nv-optimize-driver-scheduler',
  'amd-disable-chill','amd-disable-vsr','amd-enable-antilag','amd-disable-rtss-sync',
  'amd-max-power-limit','amd-disable-smart-access','amd-disable-hdcp','amd-set-gpu-mode',
  'amd-disable-overlay','amd-optimize-memory',
  'dx-shader-cache-enable','dx-disable-debug-layer','dx-optimize-agility-sdk',
  'dx-force-hw-d3d','dx-disable-d3d-debug','dx-optimize-texture-format',
  'dx-enable-variable-shading','dx-optimize-present-params',
  'lat-hpet-enable','lat-timer-resolution','lat-tsc-invariant','lat-disable-synthetic',
  'lat-optimize-interrupts','lat-force-tsc','lat-disable-acpi-pm','lat-optimize-dpc',
  'atd-disable-fade','atd-disable-switch-delay','atd-optimize-dwm','atd-disable-thumbnail',
  'atd-force-classic','atd-prioritize-game','atd-disable-snap','atd-optimize-peek',
  'gpu-max-performance-mode','gpu-disable-power-gating','gpu-optimize-shader-cache',
  'gpu-disable-var-shading','gpu-set-preferred-mode','gpu-disable-frame-pacing',
  'gpu-disable-render-completion-sync','gpu-optimize-surface-prefetch','gpu-disable-frame-rate-limiter',
  'gpu-optimize-vram-allocation','gpu-disable-mpo','gpu-enable-hw-scheduler',
  'gpu-optimize-render-schedule','gpu-disable-preemption','gpu-disable-ulps',
  'gpu-set-power-limit-max','gpu-force-max-clocks','gpu-disable-tdr',
  'gpu-disable-gpu-preemption-deep',
  'intel-disable-c-states-gpu','intel-max-gpu-frequency','intel-disable-frame-scheduling',
  'intel-disable-panel-self-refresh',
  'game-optimize-priority','game-disable-dvr','game-optimize-scheduler','game-disable-game-bar-tips',
  'game-disable-background-recording','game-optimize-fullscreen','game-disable-hags',
  'game-optimize-shader-cache','game-io-priority','game-memory-priority',
  'game-disable-game-bar-complete','game-optimize-directx','game-optimize-foreground-timer',
  'game-disable-steam-overlay','game-optimize-cpu-affinity','game-disable-nagles-algorithm',
  'game-optimize-udp-buffer','game-disable-animations','game-optimize-pagefile',
  'game-disable-powersaving-gpu','game-dvr-disable','game-bar-complete',
  'game-gameconfigstore','game-dwm-priority','game-scheduler-class',
  'game-fullscreen-trick','game-hrtimer','game-foreground-priority',
  'game-fortnite-ini-optimize','game-valorant-cfg-optimize','game-cs2-cfg-optimize',
  'game-apex-cfg-optimize','game-optimize-all','game-optimize-memory-deep',
  'game-optimize-network-priority','game-disable-fullscreen-boost','game-disable-eco-mode',
  'game-disable-all-overlays',
  'reg-mmcss-priority','reg-timer-resolution','reg-priority-separation','reg-system-clock-res',
  'reg-gaming-scheduler','reg-interrupt-affinity','reg-dpc-priority','reg-io-page-lockdown',
  'windows-explorer-optimization','qol-clean-taskbar','qol-classic-photo-viewer',
  'qol-bypass-win11','qol-disable-disk-quotas','qol-optimize-browsing','qol-disable-browser-hw-accel',
  'appdb-chrome-disable-hw','appdb-chrome-disable-extensions','appdb-chrome-priority',
  'appdb-discord-disable-hw','appdb-discord-disable-autostart','appdb-discord-optimize',
  'appdb-epic-disable-telemetry','appdb-epic-disable-hw','appdb-epic-preload',
  'appdb-steam-disable-hw','appdb-steam-disable-popup','appdb-teams-disable-background',
  'appdb-edge-disable-service','appdb-spotify-disable-startup','appdb-onecloud-disable',
  'appdb-cortana-disable','appdb-xbox-disable-overlay','appdb-web-search-disable',
  'appdb-copilot-disable','appdb-weather-disable',
  'explorer-disable-search','explorer-disable-thumbnails','explorer-classic-menu',
  'explorer-disable-details-pane','explorer-optimize-views','explorer-disable-network-discovery',
  'explorer-hide-extensions','explorer-disable-quick-access','explorer-optimize-preview',
  'explorer-disable-gadgets',
  'debloat-remove-store-bloatware','debloat-remove-onedrive','debloat-clean-temp-files',
  'debloat-disable-telemetry','debloat-remove-news-widget','debloat-disable-web-experience',
  'debloat-disable-background-access','debloat-disable-store-updates','debloat-remove-xbox-packages',
  'debloat-remove-edge','debloat-remove-teams','debloat-disable-copilot',
  'debloat-remove-widgets-deep','debloat-remove-3dviewer','debloat-remove-alarms',
  'debloat-remove-camera','debloat-remove-clipchamp','debloat-remove-copilot',
  'debloat-remove-feedback','debloat-remove-gethelp','debloat-remove-yourphone',
  'debloat-remove-maps','debloat-remove-meetnow','debloat-remove-news','debloat-remove-solitaire',
  'debloat-remove-tips','debloat-remove-people','debloat-remove-taskbar-feed',
  'svc-disable-sysmain','svc-disable-diagtrack','svc-disable-wsearch','svc-disable-tablet-input',
  'svc-disable-bluetooth-av','svc-disable-windows-error','svc-disable-print-spooler',
  'svc-disable-remote-registry','svc-disable-xbox-live','svc-disable-phone-link',
  'startup-disable-cortana','startup-disable-onedrive','startup-disable-teams',
  'startup-disable-edge-updater','startup-disable-adobe-updater','startup-disable-discord-startup',
  'startup-disable-epic-games','startup-disable-steam','startup-disable-spotify',
  'startup-disable-widgets',
  'power-ultimate-performance','power-disable-power-saving','power-disable-sleep',
  'power-disable-hibernate','power-disable-link-state','power-disable-processor-c-states',
  'power-disable-usb-suspend','power-max-pcie-power','power-processor-performance',
  'power-disable-dynamic-boost',
  'sec-disable-smartscreen','sec-disable-realtime-protection','sec-disable-defender-scheduled',
  'sec-disable-sample-submission','sec-disable-network-protection',
  'wu-disable-auto-update','wu-disable-restart-reminder','wu-pause-updates-30days',
  'wu-disable-drivers-update','wu-disable-office-updates',
  'edge-disable-startup-boost','edge-disable-background-tabs','edge-disable-preloading',
  'chrome-disable-background-apps','chrome-disable-renderer-bg','browser-disable-hw-accel',
  'chrome-deep-debloat','discord-deep-debloat','edge-deep-debloat','firefox-deep-debloat',
  'mem-optimize-pagefile','mem-large-system-cache','mem-flush-timer','mem-deoptimize-standby',
  'mem-disable-superfetch','mem-clean-standby',
  'vis-disable-transparency','vis-dark-mode','vis-disable-acrylic','vis-disable-animations',
  'vis-minimize-maximize','vis-disable-fade','vis-start-menu-clean','vis-context-menu-classic',
  'windows-disable-all-animations','windows-disable-all-services','windows-optimize-explorer-deep',
  'bt-disable-pairing-reminder','bt-disable-auto-reconnect',
  'monitor-max-refresh-rate','monitor-disable-vrr-flicker','monitor-optimize-color-accuracy',
  'obs-optimize-process-priority','obs-optimize-encoder','obs-disable-preview',
  'vr-optimize-timing','vr-optimize-render-pipeline','vr-disable-async-reprojection',
  'input-optimize-gamepad-latency','input-disable-touchscreen','input-optimize-tablet-pen',
  'mouse-disable-angle-snapping','mouse-optimize-polling-rate','mouse-disable-smoothing',
  'mouse-optimize-sensitivity-curve',
  'timer-disable-power-saving-timer','timer-force-1ms',
  'clean-dns-cache','clean-font-cache','clean-icon-cache','clean-wu-cache',
  'clean-crash-dumps','clean-browser-cache','clean-windows-search','clean-recycle-bin',
  'clean-event-logs','clean-windows-prefetch','clean-defender-cache','clean-steam-cache',
  'clean-nvidia-shader-cache','clean-amd-shader-cache',
  'cpu-disable-idle-states','cpu-max-performance-bios',
  'sys-optimize-fps','sys-optimize-device-affinities','sys-optimize-msi',
  'sys-reduce-background','sys-enable-modern-memory','sys-disable-services',
  'sys-optimize-storage','sys-optimize-browser-bg',
  'storage-ssd-optimization','storage-trim-optimization','storage-nvme-optimization',
  'storage-prefetch-manager','storage-enable-write-cache','storage-disable-ahci-link-power',
  'net-optimize-dns','net-reduce-congestion','net-disable-lso','net-disable-nagle',
  'net-disable-power-saving','net-optimize-mtu','net-disable-network-throttling',
  'net-optimize-connection-limits','net-disable-netbios',
  'audio-disable-enhancements','audio-usb-optimization','audio-optimize-buffer-size',
  'audio-disable-spatial-sound','audio-set-exclusive-mode','audio-disable-midi-synth',
  'audio-optimize-sample-rate','audio-disable-low-latency',
  'usb-selective-suspend-disable','keyboard-disable-filter','keyboard-usb-power-mgmt',
  'privacy-reduce-ads','privacy-optimize-smb','privacy-disable-security-questions',
  'privacy-harden-security','privacy-disable-vpn','privacy-disable-ucpd','privacy-unlock-eu-privacy',
  'privacy-redirect-web-searches','privacy-disable-driver-updates','privacy-disable-vm-support',
  'gpu-max-performance-mode','gpu-disable-power-gating','gpu-optimize-shader-cache',
  'gpu-disable-var-shading','gpu-set-preferred-mode','gpu-disable-frame-pacing',
  'game-optimize-priority','game-disable-dvr','game-optimize-scheduler',
  'game-disable-background-recording','game-optimize-fullscreen',
  'nv-disable-vsync','nv-low-latency','nv-hardware-scheduling','nv-texture-filtering',
  'nv-disable-telemetry','nv-optimize-performance',
  'sys-high-performance','sys-enable-game-mode','sys-disable-gamebar','mouse-disable-acceleration',
  'cpu-core-parking-disable','sys-disable-hibernation',
])

export const availableTweaks: Tweak[] = auditedCatalogue
  .filter((tweak) => APPROVED_TWEAK_IDS.has(tweak.id))
  .map((tweak) => {
    const copy: Record<string, Partial<Tweak>> = {
      'sys-high-performance': {
        description: 'Switches to the built-in High performance plan. It can prevent aggressive CPU power saving, at the cost of power and heat.',
        gamingImpact: 'Situational: can improve consistency on systems limited by power management.'
      },
      'sys-enable-game-mode': {
        description: 'Enables Windows Game Mode. Windows may prioritize the active game and reduce some background activity.',
        gamingImpact: 'Low-impact, workload-dependent scheduling preference.'
      },
      'sys-disable-gamebar': {
        description: 'Disables Xbox Game Bar capture and background recording. Keep it enabled if you use Game Bar capture or widgets.',
        gamingImpact: 'Avoids capture/overlay overhead only when those features would otherwise be active.'
      },
      'mouse-disable-acceleration': {
        description: 'Disables Enhance Pointer Precision and restores the standard 6/11 mouse sensitivity position. This changes pointer feel, not hardware latency.',
        gamingImpact: 'Provides consistent mouse mapping for games that use Windows pointer input.'
      },
      'cpu-core-parking-disable': {
        description: 'Sets the active power plan minimum core parking percentage to 100% on AC power. This may help specific latency-sensitive workloads but increases idle power.',
        gamingImpact: 'Situational; modern schedulers already manage cores effectively on many systems.'
      },
      'sys-disable-hibernation': {
        description: 'Disables hibernation and Fast Startup, freeing hiberfil.sys disk space. It does not increase game FPS.',
        gamingImpact: 'Storage-only change; disables Hibernate and Fast Startup.'
      },
      'storage-ssd-optimization': {
        description: 'Disables NTFS last-access timestamp updates. Modern Windows normally uses this behavior already; expected performance impact is negligible.',
        gamingImpact: 'Low impact; retained as an explicit filesystem preference.'
      },
      'storage-trim-optimization': {
        description: 'Requests an immediate TRIM retrim on the system volume. Useful only for supported SSDs; it is not a permanent FPS tweak.',
        gamingImpact: 'May help SSD housekeeping; no expected frame-rate change.'
      },
      'windows-explorer-optimization': {
        description: 'Opens File Explorer to This PC rather than Home. This is a UI preference, not a performance optimization.',
        gamingImpact: 'No gaming performance effect.'
      },
      'sys-disable-tips': { description: 'Turns off Windows suggestion and welcome-content notifications for the current user.', gamingImpact: 'Privacy/UI preference; no measurable FPS effect.' },
      'sys-disable-widgets': { description: 'Disables the Windows Widgets feed through the supported policy value. It is a feature preference, not an FPS boost.', gamingImpact: 'May avoid widget activity; impact is normally negligible.' },
      'sys-disable-activity-history': { description: 'Disables publishing and uploading Windows activity history by policy.', gamingImpact: 'Privacy preference; no measurable game-performance claim.' },
      'sys-disable-location': { description: 'Disables Windows location services by policy. Location-aware apps and Find my device may stop working.', gamingImpact: 'Privacy preference; no measurable game-performance claim.' },
      'privacy-disable-ad-id': { description: 'Disables the per-user advertising ID. This is a privacy setting, not a performance tweak.', gamingImpact: 'No gaming performance effect.' },
    }
    return { ...tweak, ...copy[tweak.id] }
  })
