...
export const gameProfiles: GameProfile[] = [
  {
    ...
    tweakTiers: {
      free: [
        ...
        'snd-disable-spatial', 'atd-disable-fade', 'atd-disable-switch-delay',
        'atd-disable-thumbnail', 'atd-force-classic', 'appdb-discord-disable-hw',
        'appdb-steam-disable-hw', 'appdb-epic-disable-hw', 'appdb-chrome-disable-hw',
        'explorer-classic-menu', 'explorer-disable-quick-access',
      ],
      pro: [
        ...
        'input-gaming-mode', 'snd-exclusive-mode', 'snd-reduce-buffer', 'bcd-optimize-boot',
        'nv-max-frames-ahead', 'nv-shader-cache-size', 'nv-rm-gpu-accl', 'lat-hpet-enable',
        'lat-optimize-interrupts', 'atd-optimize-dwm', 'atd-prioritize-game',
        'appdb-discord-optimize', 'appdb-chrome-priority', 'dx-shader-cache-enable',
      ],
      premium: [
        'sys-disable-mitigations', 'sys-optimize-fps', 'sys-realtime-priority-games',
        'sys-foreground-boost', 'gpu-disable-ulps', 'snd-mmcss-audio', 'snd-optimize-audio-thread',
        'bcd-timer-resolution', 'bcd-disable-dynamic-tick', 'bcd-use-platform-clock',
        'nv-disable-gpu-preemption', 'nv-max-power-management', 'lat-timer-resolution',
        'lat-optimize-dpc', 'dx-enable-variable-shading', 'dx-optimize-present-params',
      ],
    },
    priority: 1
  },
  ...
  },
  {
    ...
    tweakTiers: {
      ...
      pro: [
        ...
        'snd-exclusive-mode', 'snd-reduce-buffer', 'bcd-optimize-boot',
        'nv-max-frames-ahead', 'nv-shader-cache-size', 'nv-rm-gpu-accl', 'lat-hpet-enable',
        'lat-optimize-interrupts', 'atd-optimize-dwm', 'atd-prioritize-game',
        'appdb-discord-optimize', 'appdb-chrome-priority', 'dx-shader-cache-enable',
      ],
      premium: [
        'sys-optimize-fps', 'sys-realtime-priority-games', 'sys-foreground-boost',
        'snd-mmcss-audio', 'snd-optimize-audio-thread',
        'bcd-timer-resolution', 'bcd-disable-dynamic-tick', 'bcd-use-platform-clock',
        'nv-disable-gpu-preemption', 'nv-max-power-management', 'lat-timer-resolution',
        'lat-optimize-dpc', 'dx-enable-variable-shading', 'dx-optimize-present-params',
      ],
  ...
  },
  {
    ...
    tweakTiers: {
      ...
      premium: [
        'sys-optimize-fps', 'snd-mmcss-audio', 'snd-optimize-audio-thread',
        'bcd-timer-resolution', 'bcd-disable-dynamic-tick', 'bcd-use-platform-clock',
        'nv-disable-gpu-preemption', 'nv-max-power-management', 'lat-timer-resolution',
        'lat-optimize-dpc', 'dx-enable-variable-shading', 'dx-optimize-present-params',
      ],
