...
const PLANS = [
  {
    ...
    features: [
      ...
      '1 game profile',
      'Essential tweaks (Game Mode, DVR)',
      'Basic rollback',
      'Benchmark tool',
    ],
    icon: Shield,
  ...
  },
  {
    ...
    price: '€4.99',
    period: '/key',
    description: 'Advanced optimizations for competitive edge',
    features: [
      'Everything in Free',
      ...
      'Process optimizer',
      'Live Monitor (real-time stats)',
      'BIOS Guide (XMP, C-States, ReBAR)',
    ],
    icon: Zap,
    color: 'var(--accent)',
    recommended: false,
  },
  {
    ...
    price: '€7.99',
    period: '/key',
    description: 'Maximum performance, zero limits',
    features: [
      'Everything in Pro',
      'Full system restore',
      'VBS & mitigations tweaks',
      'Realtime process priority',
      'GPU power management',
      'Exclusive premium tweaks',
      'Priority support',
